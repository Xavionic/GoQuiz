...
class TeacherUncompletedListQuizAdapter2(private val quizList : ArrayList<TempQuiz>): RecyclerView.Adapter<TeacherUncompletedListQuizAdapter2.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            Toast.makeText(holder.itemView.context, "Kamu memilih " + quizList[holder.adapterPosition].description, Toast.LENGTH_SHORT).show()
